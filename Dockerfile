FROM --platform=${BUILDPLATFORM:-linux/amd64} golang:1.25.12 AS builder
...
COPY --from=ghcr.io/spiffe/aws-spiffe-workload-helper:0.0.4 /ko-app/cmd /usr/bin/aws-spiffe-workload-helper
