...
const (
	socketPath    = "unix:///spiffe-workload-api/socket"
	serverAddress = "spiffe-server.spiffe-demo.svc.cluster.local:443"
)
...
func run(ctx context.Context) error {
	...
	// Allowed SPIFFE ID
	serverID := spiffeid.RequireFromString("spiffe://spire.internal.mattiasgees.be/ns/spiffe-demo/sa/spiffe-server")
